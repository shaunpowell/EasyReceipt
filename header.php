...
<head>
	...
	<link href="http://localhost/EasyReceipt_wp/wp-content/themes/plutoniumous/style.css" media="all" type="text/css" rel="stylesheet">
  <!---<link href="http://localhost/EasyReceipt/style.css" media="all" type="text/css" rel="stylesheet">--->
  <link href="http://localhost/EasyReceipt/styles/style.css" media="all" type="text/css" rel="stylesheet">
	<link type="text/css" rel="stylesheet" href="http://fonts.googleapis.com/css?family=Droid+Serif">
	<link href="http://localhost/EasyReceipt_wp/xmlrpc.php" rel="pingback">
